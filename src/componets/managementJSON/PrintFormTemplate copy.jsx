...
function PrintFormTemplate({ formSelectLocal, setFormSelectLocal }) {
  ...
  const [formSelectLocal2, setFormSelectLocal2] = useState({});
  const [lengthOfArrayOfBlocks, setLengthOfArrayOfBlocks] = useState(0);

  useState(() => {
    setFormSelectLocal2(formSelectLocal)
        ...
        <div className="row d-flex flex-row justify-content-start align-items-center gx-0 shadow-sm graycolor500 p-1 mb-2">
          <div className="col-3 text-start m-0 p-0 text-start" >
            <LabelElem_PB
              ...
              required={true}
              disabled={true}
              response={[formSelectLocal.title_Form]}
              placeholder={formSelectLocal.title_Form}
              size={50}
          ...
          <div className="col-3 offset-md-5" >
            <TextElem_PB
              ...
              disabled={true}
              response={[""]}
              placeholder={formSelectLocal.id_Form}
              size={12}
...
1.-  Cargo en la variable de estado de React:  formSelectLocal, el valor del objeto de formulario: "formInput", 
