...
function InfoOfElement() {
  ...
  return (
    <div className="contInfoOfElement">
      <div className="infoComponent container-fluid bg-secondary" >
        ...
        <div className="contInfoForm container-fluid mb-1">
      ...
      <div className="contOfData container-fluid bg-secondary">
        <div className="contComponent container-fluid my-1 p-1">
      ...
      <div className="contOfData container-fluid bg-secondary">
        <div className="contInfoForm container my-1">
          ...
          <div className="row gap-0 mb-1 mx-0">
            <div className="FieldsHorizontal d-flex justify-content-start align-items-center p-1 ">
              <div className="col-4 d-flex flex-column justify-content-start align-items-start bg-body ps-1 me-1">
              ...
              <div className="col-8 d-flex flex-column justify-content-start align-items-start bg-body px-1">
