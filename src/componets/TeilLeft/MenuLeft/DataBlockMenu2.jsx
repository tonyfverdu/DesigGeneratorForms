...
function findIndexBlockSelect2(parArrayBlocks, parBlockSelect) {
  if (!Array.isArray(parArrayBlocks)) {
    throw new Error('Error: The argument of the function "findIndexBlockSelect2" must be an array!!');
  }

  const indexBlockSelect = parArrayBlocks.findIndex(block => block.id_Block === parBlockSelect.id_Block);
  if (indexBlockSelect === -1) {
    throw new Error('Error: There is not the elements in the array of the function "findIndexBlockSelect"');
  }
